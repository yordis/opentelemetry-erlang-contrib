defmodule OpentelemetryGrpc.MixProject do
  ...
  defp deps do
    [
      ...
      {:telemetry, "~> 1.0"},
      {:grpc_core, github: "yordis/grpc", branch: "yordis/improve-otel", sparse: "grpc_core"},
      {:grpc_server, github: "yordis/grpc", branch: "yordis/improve-otel", sparse: "grpc_server"},
      {:grpc_client, github: "yordis/grpc", branch: "yordis/improve-otel", sparse: "grpc_client"},
      {:protobuf, "~> 0.15"},
